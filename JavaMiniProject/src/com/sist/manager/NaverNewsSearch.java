...
/*
 ...
 {	"lastBuildDate":"Tue, 21 Jan 2025 12:31:20 +0900",	"total":675726,	"start":1,	"display":10,	
 "items":[		
...
public class NaverNewsSearch {
	 ...
	 public static List<NewsVO> newsSearchData(String fd)
	 {
		 ...
		 String clientId = "07h3PpdvVSDUBsm5lflG"; //애플리케이션 클라이언트 아이디
	     String clientSecret = "hmN7gMFyUx"; //애플리케이션 클라이언트 시크릿
	     ...
	     try {
			 ...
			 JSONParser jp = new JSONParser();//데이터분리
			 ...
			 for(int i=0;i<items.size();i++)
			 {
				 ...
				 //애기봉 주변 <b>맛집</b> 코스 개발과 관광객 유입을 통한 지역 -> <b>맛집</b> 제거
